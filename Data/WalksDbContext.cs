...
namespace DemoProjectAPI.Data
{
    public class WalksDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            #region Difficulty Table
            #region Seed/Preparing the data 
            var difficulies = new List<Difficulty>()
            {
                new Difficulty()
                {
                    Id = Guid.Parse("606de011-f90c-4079-89c6-471ab2e7c7fa"),
                    Name = "Easy" } ,
                new Difficulty()
                {
                    Id = Guid.Parse("c25c0d4c-ec43-4651-b74e-26b425090da0"),
                    Name = "Medium"
                } ,
                new Difficulty(){
                    Id = Guid.Parse("830cc019-585d-4857-aedf-07fa1942d4c0"),
                    Name = "Hard" }
            };
            #endregion
            #region Adding data to Model
